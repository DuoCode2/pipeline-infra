---
name: generate
description: "End-to-end website generation for a business lead. One sentence → live site. Region-agnostic, industry-agnostic — Codex makes all design decisions. Use when user says 'generate', 'build a site', 'create website', or provides a business lead."
...
## Step 2: Design (Codex's creative work)
