...
This is critical for same-category batches (e.g., 5 hair salons). Without explicit diversity constraints, Codex will default to the same "safe" choices for every site.
