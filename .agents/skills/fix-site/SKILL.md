...
cat .Codex/skills/duocode-design/references/${REGION_ID}-market.md 2>/dev/null || \
cat .Codex/skills/duocode-design/references/generic-market.md
```

Also read the a11y checklist to verify fixes don't introduce new violations:
```bash
cat .Codex/skills/duocode-design/references/a11y-checklist.md
```
