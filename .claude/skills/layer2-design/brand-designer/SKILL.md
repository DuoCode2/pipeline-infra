---
name: brand-designer
description: "Expert in brand identity, logo design, and visual brand systems. Use when creating brand identities, logos, or visual brand guidelines."
license: AGPL-3.0
metadata:
  author: duocode
  version: "1.0"
...
> **Role**: Optional supplementary tool. The core design skill is `duocode-design`.
