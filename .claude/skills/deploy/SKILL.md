...
```bash
bash ${CLAUDE_SKILL_DIR}/resources/deploy.sh [path]
```
...
bash ${CLAUDE_SKILL_DIR}/resources/deploy.sh

# Deploy specific project
bash ${CLAUDE_SKILL_DIR}/resources/deploy.sh /path/to/project

# Deploy existing tarball
bash ${CLAUDE_SKILL_DIR}/resources/deploy.sh /path/to/project.tgz
```
