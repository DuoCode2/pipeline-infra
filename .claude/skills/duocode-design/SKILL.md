---
name: duocode-design
description: "Region-aware market context, website design patterns, and Next.js scaffolding for DuoCode site generation. Region-agnostic and industry-agnostic — Claude makes all design decisions using reference material and frontend-design skill. Auto-loaded during /generate and /batch."
...
ALL design decisions are made by Claude using the `frontend-design` skill.

## Design Philosophy

Claude is the designer. The pipeline gives you:
