---
name: duocode-design
description: "DuoCode design system for business websites. Contains shared design foundations (anti-AI aesthetics, color application, typography, SVG rules) and industry-specific guidelines loaded on demand. Also covers brand identity and landing page conversion patterns."
...
Load these on demand when the specific topic is relevant:

| Topic | Reference | When to Read |
|-------|-----------|-------------|
| Brand Identity | `references/brand-identity.md` | Logo design, brand guidelines, visual asset management |
| Landing Page Patterns | `references/landing-page-patterns.md` | Section layout patterns for landing pages |
| Copy Frameworks | `references/copy-frameworks.md` | PAS, AIDA, BAB copywriting frameworks |
| Conversion Patterns | `references/conversion-patterns.md` | Conversion optimization, A/B testing |
| SEO Checklist | `references/seo-checklist.md` | Landing page SEO optimization |
