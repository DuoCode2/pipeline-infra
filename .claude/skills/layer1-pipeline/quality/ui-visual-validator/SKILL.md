...
description: "Rigorous visual validation expert specializing in UI testing, design system compliance, and accessibility verification. Use when validating UI designs, checking design system compliance, or verifying accessibility."
license: AGPL-3.0
metadata:
  author: duocode
  version: "1.0"
