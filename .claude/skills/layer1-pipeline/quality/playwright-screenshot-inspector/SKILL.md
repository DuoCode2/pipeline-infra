...
description: "LLM-powered visual testing expert for automated screenshot capture, analysis, and UI verification using Playwright with multimodal AI inspection. Use when capturing screenshots, analyzing UI, or verifying visual consistency."
license: AGPL-3.0
metadata:
  author: duocode
  version: "1.0"
