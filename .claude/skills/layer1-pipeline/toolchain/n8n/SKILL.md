---
name: n8n
description: "Develop workflows, custom nodes, and integrations for n8n automation platform. Use when designing workflows, writing custom code nodes, building TypeScript-based custom nodes, integrating external services, or implementing AI agent patterns."
license: AGPL-3.0
metadata:
  author: duocode
  version: "1.0"
