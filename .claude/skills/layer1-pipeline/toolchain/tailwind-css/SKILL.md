---
name: tailwind-css
description: "Tailwind CSS utility-first framework for rapid UI development with responsive design and dark mode. Use when working with Tailwind CSS, utility classes, responsive layouts, or dark mode."
license: AGPL-3.0
metadata:
  author: duocode
  version: "1.0"
